...
- LibreWolf gets a system policy that auto-installs CanvasBlocker, ClearURLs, Cookie AutoDelete, I still don't care about cookies, LocalCDN, Privacy Badger, SponsorBlock, and uBlock Origin.
